# WeatherAppSample
Weather app to display weather info for a selected city. Developed in Kotlin using Clean Architecture, MVVM, Architecture Components (ViewModel, LiveData, Room), RxJava2, Google Places API
